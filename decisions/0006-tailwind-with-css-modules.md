...
The need to support "custom visuals" is in line with how I know I've made UI decisions in the past, sometimes including visual flair involving shapes, glows & lightings, patterns, and animations that Tailwind wouldn't support very well. Not that elements like this would be included on a large portion of pages; there should just remain well-defined support for custom UI decisions to be possible, as I know that at least a few of those decisions are probable.
