# Why Aren't Next.js \<Link> and \<Image> Being Used?

These components exist to reduce unnecessary loading in Next.js applications, so their exclusion may seem questionable. However, their exclusion is deliberate, and that's because this application includes design decisions that sidestep the optimizations that these components normally provide.
